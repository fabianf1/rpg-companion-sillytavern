...
import { $userStatsContainer, extensionSettings } from "../../core/state.js";
...
export function setupClassicStatsButtons() {
	...
	$userStatsContainer.on("click", ".rpg-stat-increase", function () {
		...
		if (extensionSettings.classicStats[stat] < 999) {
			...
			$(this)
				.closest(".rpg-classic-stat")
				.find(".rpg-classic-stat-value")
				.text(extensionSettings.classicStats[stat]);
			updateFabWidgets();
		}
	});
